...
1. Arrays & Hashing (9 Questions)
    1. [Contains Duplicate (Easy)](https://neetcode.io/problems/duplicate-integer) - [Solution](src/contains_duplicate.cc)
    2. [Valid Anagram (Easy)](https://neetcode.io/problems/is-anagram) - [Solution](src/valid_anagram.cc)
    3. [Two Sum (Easy)](https://neetcode.io/problems/two-integer-sum) - [Solution](src/tow_sum.cc)
    4. [Group Anagrams (Medium)](https://neetcode.io/problems/anagram-groups) [Solution](src/group_anagrams.cc)
    5. [Top K Frequent Elements (Medium)](https://neetcode.io/problems/top-k-elements-in-list) - [Solution](src/top_k_frequent_elements.cc)
    6. [Encode and Decode Strings (Medium)](https://neetcode.io/problems/string-encode-and-decode) - [Solution](src/encode_decode_string.cc)
    7. [Product of Array Except Self (Medium)](https://neetcode.io/problems/products-of-array-discluding-self) - [Solution](src/product_of_array_except_self.cc)
    8. [Valid Sudoku (Medium)](https://neetcode.io/problems/valid-sudoku) - [Solution](src/valid_sudoku.cc)
    9. [Longest Consecutive Sequence (Medium)](https://neetcode.io/problems/longest-consecutive-sequence) - [Solution](src/longest_consecutive_sequence.cc)
    
2. Two Pointers (5 Questions)
    1. [Valid Palindrome (Easy)](https://neetcode.io/problems/is-palindrome) - [Solution](src/best_time_to_buy_sell_stock.cc) [2 transactions](), and [K transactions]](src/
    2. [Two Sum II - Input Array Is Sorted (Medium)](https://neetcode.io/problems/two-integer-sum-ii) - [Solution](src/two_integer_sum2.cc)
    3. [3Sum (Medium)](https://neetcode.io/problems/three-integer-sum) - [Solution](src/3sum.cc)
    4. [Container With Most Water (Medium)](https://neetcode.io/problems/max-water-container) - [Solution](src/container_with_most_water.cc)
    5. [Trapping Rain Water (Hard)](https://neetcode.io/problems/trapping-rain-water) - [Solution](src/trapping_rain_water.cc)
    
3. Sliding Window (6 Questions)
    1. [Best Time to Buy and Sell Stock (Easy)](https://neetcode.io/problems/buy-and-sell-crypto) -- 
       [Solution](src/best_time_to_buy_sell_stock.cc), [K transaction case](src/best_time_to_buy_sell_stock_2.cc)
    2. [Longest Substring Without Repeating Characters (Medium)](https://neetcode.io/problems/longest-substring-without-duplicates) -- 
       [Solution](src/longest_substring_without_dup.cc)
    3. [Longest Repeating Character Replacement (Medium)](https://neetcode.io/problems/longest-repeating-substring-with-replacement) -- 
       [Solution](src/longest_repeating_char_replacement.cc)
    4. [Permutation in String (Medium)](https://neetcode.io/problems/permutation-string) -- [Solution](src/.cc)
    5. [Minimum Window Substring (Hard)](https://neetcode.io/problems/minimum-window-with-characters) -- [Solution](src/minimum_window_substring.cc)
    6. [Sliding Window Maximum (Hard)](https://neetcode.io/problems/sliding-window-maximum) -- [Solution](src/sliding_window_maximum.cc)
  
4. Stack (7 Questions)
    1. [Valid Parentheses (Easy)](https://neetcode.io/problems/validate-parentheses) -
       [Solution](src/valid_palindrome.cc)
    2. [Min Stack (Medium)](https://neetcode.io/problems/minimum-stack) - 
       [Solution](src/min_stack.cc)
    3. [Evaluate Reverse Polish Notation (Medium)](https://neetcode.io/problems/evaluate-reverse-polish-notation) - 
       [Solution](src/evaluate_reverse_polish_expr.cc)
    4. [Daily Temperatures (Medium)](https://neetcode.io/problems/daily-temperatures) -
       [Solution](src/daily_temperature.cc)
    5. [Car Fleet (Medium)Largest Rectangle in Histogram (Hard)](https://neetcode.io/problems/car-fleet) - 
...
5. Binary Search
    1. [Binary Search (Easy)](https://neetcode.io/problems/binary-search) -
       [Solution](src/binary_search.cc)
    2. [Search a 2D Matrix (Medium)](https://neetcode.io/problems/search-2d-matrix) - 
       [Solution](src/search_2d_matrix.cc)
    3. [Koko Eating Bananas (Medium)](https://neetcode.io/problems/eating-bananas) - 
       [Solution](src/koko_eating_bananas.cc)
    4. [Find Minimum in Rotated Sorted Array (Medium)](https://neetcode.io/problems/find-minimum-in-rotated-sorted-array) - 
       [Solution](src/find_min_in_rotated_array/*.cc)
    5. [Search in Rotated Sorted Array (Medium)](https://neetcode.io/problems/find-target-in-rotated-sorted-array) - 
       [Solution](src/search_in_rotated_sorted_array.cc)
    6. [Time Based Key Value Store (Medium)](https://neetcode.io/problems/time-based-key-value-store) - 
...
6. Linked List (11 Problems)
    ...
    3. [Linked List Cycle (Easy)](https://neetcode.io/problems/linked-list-cycle-detection) -
       [Solution](src/linked_list_cycle_detection.cc)
    4. [Reorder List (Medium)](https://neetcode.io/problems/reorder-linked-list) -
       [Solution](src/reorder_linked_list.cc)
    5. [Remove Nth Node From End of List (Medium)](https://neetcode.io/problems/remove-node-from-end-of-linked-list) -
       [Solution](src/remove_nth_node_from_end_of_list.cc)
    6. [Copy List with Random Pointer (Medium)](https://neetcode.io/problems/copy-linked-list-with-random-pointer) -
       [Solution](src/copy_linked_list_with_random_pointer.cc)
    7. [Add Two Numbers (Medium)](https://neetcode.io/problems/add-two-numbers) -
       [Solution](src/add_two_numbers.cc)
    8. [Find the Duplicate Number (Medium)](https://neetcode.io/problems/find-duplicate-integer) -
       [Solution](src/find_duplicate_number.cc)
    9. [LRU Cache (Medium)](https://neetcode.io/problems/lru-cache) -
       [Solution](src/lru_cache.cc)
    10. [Merge k Sorted Lists (Hard)](https://neetcode.io/problems/merge-k-sorted-linked-lists) -
...
7. Trees (15 Problems)
    ...
    2. [Maximum Depth of Binary Tree(Easy)](https://neetcode.io/problems/depth-of-binary-tree) -
       [Solution](src/maximum_depth_of_binary_tree.cc)
    3. [Diameter Of Binary Tree (Easy)](https://neetcode.io/problems/binary-tree-diameter) -
       [Solution](src/diameter_of_binary_tree.cc)
    4. [Balanced Binary Tree (Easy)](https://neetcode.io/problems/balanced-binary-tree) -
       [Solution](src/balanced_binary_tree.cc)
    5. [Same Tree (Easy)](https://neetcode.io/problems/same-binary-tree) -
       [Solution](src/same_tree.cc)
    6. [Subtree of Another Tree (Easy)](https://neetcode.io/problems/subtree-of-a-binary-tree) -
       [Solution](src/subtree_of_another_tree.cc)
    7. [LCA of BST (Medium)](https://neetcode.io/problems/lowest-common-ancestor-in-binary-search-tree) -
       [Solution](src/lowest_common_ancestor.cc)
    8. [Binary Tree Level Order Traversal (Medium)](https://neetcode.io/problems/level-order-traversal-of-binary-tree) -
       [Solution](src/binary_tree_level_order_traversal.cc)
    9. [Binary Tree Right Side View (Medium)](https://neetcode.io/problems/binary-tree-right-side-view) -
       [Solution](src/binary_tree_right_side_view.cc)
    10. [Count Good Nodes in Binary Tree (Medium)](https://neetcode.io/problems/count-good-nodes-in-binary-tree) -
        [Solution](src/count_good_nodes_in_binary_tree.cc)
    11. [Validate Binary Search Tree (Medium)](https://neetcode.io/problems/valid-binary-search-tree) -
        [Solution](src/valid_binary_search_tree.cc)
    13. [Kth Smallest, and Construct Tree  (Medium)](https://neetcode.io/problems/kth-smallest-integer-in-bst) -
        [Solution](src/kth_smallest_integer_in_BST.cc)
    14. [Construct Binary Tree From Preorder And Inorder Traversal  (Medium)](https://neetcode.io/problems/binary-tree-from-preorder-and-inorder-traversal) -
        [Solution](src/construct_binary_tree_from_preorder_inorder.cc)
    15. [Binary Tree Maximum Path Sum (Hard)](https://neetcode.io/problems/binary-tree-maximum-path-sum) -
        [Solution](src/binary_tree_maximum_path_sum.cc)
    16. [Serialze And Deserizlize Binary Tree (Hard)](https://neetcode.io/problems/serialize-and-deserialize-binary-tree) -
...
8. Heap / Priority Queue
    ...
    4. [K Closest Points to Origin (Medium)](https://neetcode.io/problems/k-closest-points-to-origin) -
       [Solution](src/k_closest_points_to_origin.cc)
    5. [Kth Largest Element In An Array (Medium)](https://neetcode.io/problems/kth-largest-element-in-an-array) -
       [Solution](src/kth_largest_element_in_array.cc)
    6. [Task Scheduler (Medium)](https://neetcode.io/problems/task-scheduling) -
       [Solution](src/task_scheduler.cc)
    7. [Design Twitter (Medium)](https://neetcode.io/problems/design-twitter-feed) -
...
9. Backtracking
    ...
    3. [Combination Sum II (Medium)](https://neetcode.io/problems/combination-target-sum-ii) -
       [Solution](src/combination_sum_II.cc)
    4. [Permutations (Medium)](https://neetcode.io/problems/permutations) -
       [Solution](src/permutations.cc)
    5. [Subsets II (Medium)](https://neetcode.io/problems/subsets-ii) -
       [Solution](src/power_set_II.cc)
    6. [Gnerate Parentheses (Medium)](https://neetcode.io/problems/generate-parentheses) -
       [Solution](src/generate_parentheses.cc)
    7. [Word Search (Medium)](https://neetcode.io/problems/search-for-word) -
       [Solution](src/word_search.cc)
    8. [Palindrome Partitioning (Medium)](https://neetcode.io/problems/palindrome-partitioning) -
       [Solution](src/palindrome_partitioning.cc)
    9. [Letter Combinations of a Phone Number (Medium)](https://neetcode.io/problems/combinations-of-a-phone-number) -
